...
Notion의 `추천 20편 · 읽기 순서` 보기와 연결되는 로드맵입니다. 공부 기록과 완료 여부의 기준은 Notion입니다. Notion의 현재 분류와 논문 ID를 따르며, 읽기 순서는 `Keys`의 `P0-01`~`P0-20`으로 표시합니다.

1–6: Diffusion·flow·행동 생성 / 7: ACT / 8–14: 시각 표현·VLM·적응 / 15–20: VLA·평가.
