...
export function StudyChat({
  ...
  const quickPrompts = hasAreas
    ? ["선택한 영역을 설명해줘", "선택한 수식을 단계별로 설명해줘", "선택한 그림이나 표의 의미를 분석해줘"]
